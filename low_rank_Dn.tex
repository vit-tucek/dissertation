\chapter[Cohomology of unitarizable modules for SO*(8)]{Cohomology of unitarizable modules for $\mathrm{SO}^*(8)$}

\section[so(8): (0, 1, 0, -6)]{$\boldsymbol{\mathfrak{s0}^*(8)\!:\; \omega_{2} - 6\omega_{4} }$}
...
\section[so(8): (0, 0, 1, -3)]{$\boldsymbol{\mathfrak{s0}^*(8)\!:\; \omega_{3} - 3\omega_{4} }$}
...
\section[so(8): (0, 0, 0, 0)]{$\boldsymbol{\mathfrak{s0}^*(8)\!:\; 0 }$}
...
\section[so(8): (0, 0, 0, -2)]{$\boldsymbol{\mathfrak{s0}^*(8)\!:\; -2\omega_{4} }$}
...
\section[so(8): (1, 1, 0, -7)]{$\boldsymbol{\mathfrak{s0}^*(8)\!:\; \omega_{1} + \omega_{2} - 7\omega_{4} }$}
...
\section[so(8): (1, 0, 1, -5)]{$\boldsymbol{\mathfrak{s0}^*(8)\!:\; \omega_{1} + \omega_{3} - 5\omega_{4} }$}
...
\section[so(8): (1, 0, 0, -3)]{$\boldsymbol{\mathfrak{s0}^*(8)\!:\; \omega_{1} - 3\omega_{4} }$}
