\section[Cohomology of unitarizable modules for An, 1 < n < 6]{Cohomology for $A_n$, $2 \leq n \leq 5$}
...
Cone of unitarizable weights: $-\left(a_{2} + a_{3} + 3\right)\omega_{1} + a_2 \omega_2 + \left(a_{3} + 1\right)\omega_{3}$ \\
...
Cone of unitarizable weights: $-\left(a_{2} + a_{3} + a_{4} + 4\right)\omega_{1} + a_2\omega_2 + a_3\omega_3 + \left(a_{4} + 1\right)\omega_{4}$ \\
...
Cone of unitarizable weights: $\left(a_{1} + 1\right)\omega_{1} - \left(a_{1} + a_{3} + a_{4} + 5\right)\omega_{2} + a_3\omega_3 + \left(a_{4} + 1\right)\omega_{4}$ \\
...
\textbf{•}Cone of unitarizable weights: $-\left(a_{3} + a_{4} + 3\right)\omega_{2} + a_3\omega_3 + \left(a_{4} + 1\right)\omega_{4}$ \\
...
\noindent $\lambda = $ $-\left(a_{3} +  3\right)\omega_{2} + a_3\omega_3 + \omega_{4}$ \\
...
\noindent $\lambda = $ $-\left(a_{3} + a_{4} + 3\right)\omega_{2} + a_3\omega_3 + \left(a_{4} + 1\right)\omega_{4}$, $a_4 \geq 1$ \\
\noindent Set of singular roots: $\emptyset$ \\
