\chapter{Cohomology of unitarizable modules for $C_n$, $2 \leq n \leq 3$}
...
%\noindent $\lambda = $ $\left(a_{2} + 2\right)\omega_{2} - \left(a_{2} + 3\right)\omega_{3}$ \\
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_1) at (46.5bp,8.5bp) [draw,draw=none] {$\left(0,\,a_{2} + 2,\,-a_{2} - 3\right)$};
  \node (node_0) at (167.0bp,8.5bp) [draw,draw=none] {$\left(2,\,a_{2},\,-a_{2} - 3\right)$};
