...
\subsubsection{$\boldsymbol{\mathfrak{su}(1, 1)\!:\; p'= 1,\, q' = 1,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(1, 2)\!:\; p'= 1,\, q' = 1,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(1, 2)\!:\; p'= 1,\, q' = 2,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(1, 3)\!:\; p'= 1,\, q' = 1,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(1, 3)\!:\; p'= 1,\, q' = 2,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(1, 3)\!:\; p'= 1,\, q' = 3,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 2)\!:\; p'= 1,\, q' = 1,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 2)\!:\; p'= 1,\, q' = 2,\, l = 1}$}
...
%\noindent $\lambda = $ $\left(a_{1} + 1\right)\omega_{1} - \left(a_{1} + 2\right)\omega_{2}$ \\
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 2)\!:\; p'= 2,\, q' = 1,\, l = 1}$}
...
%\noindent $\lambda = $ $-\left(a_{3} + 2\right)\omega_{2} + \left(a_{3} + 1\right)\omega_{3}$ \\
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 2)\!:\; p'= 2,\, q' = 2,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 2)\!:\; p'= 2,\, q' = 2,\, l = 2}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(1, 4)\!:\; p'= 1,\, q' = 1,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(1, 4)\!:\; p'= 1,\, q' = 2,\, l = 1}$}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_2) at (224.0bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - a_{3} - 4,\,a_{2},\,a_{3},\,1\right)$};
  \node (node_1) at (374.0bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - a_{3} - 5,\,a_{2},\,a_{3},\,0\right)$};
  \node (node_0) at (65.5bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - a_{3} - 3,\,a_{2},\,a_{3} + 1,\,0\right)$};
  \draw [black,->] (node_2) ..controls (289.62bp,8.5bp) and (298.18bp,8.5bp)  .. (node_1);
  \draw [black,->] (node_0) ..controls (139.44bp,8.5bp) and (148.04bp,8.5bp)  .. (node_2);
%
\end{tikzpicture}
  \caption{Nilpotent cohomology / BGG resolution}
\end{figure}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(1, 4)\!:\; p'= 1,\, q' = 3,\, l = 1}$}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_3) at (306.5bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - 4,\,a_{2},\,0,\,1\right)$};
  \node (node_2) at (183.5bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - 3,\,a_{2},\,1,\,0\right)$};
  \node (node_1) at (429.5bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - 5,\,a_{2},\,0,\,0\right)$};
  \node (node_0) at (52.0bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - 2,\,a_{2} + 1,\,0,\,0\right)$};
  \draw [black,->] (node_2) ..controls (235.38bp,8.5bp) and (244.09bp,8.5bp)  .. (node_3);
  \draw [black,->] (node_0) ..controls (112.53bp,8.5bp) and (121.18bp,8.5bp)  .. (node_2);
  \draw [black,->] (node_3) ..controls (358.38bp,8.5bp) and (367.09bp,8.5bp)  .. (node_1);
%
\end{tikzpicture}
  \caption{Nilpotent cohomology / BGG resolution}
\end{figure}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(1, 4)\!:\; p'= 1,\, q' = 4,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 3)\!:\; p'= 1,\, q' = 1,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 3)\!:\; p'= 1,\, q' = 2,\, l = 1}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 3)\!:\; p'= 1,\, q' = 3,\, l = 1}$}
...
\node (node_2) at (52.0bp,8.5bp) [draw,draw=none] {$\left(a_{1} + 1,\,-a_{1} - 2,\,0,\,0\right)$};
  \node (node_1) at (183.5bp,8.5bp) [draw,draw=none] {$\left(a_{1},\,-a_{1} - 3,\,1,\,0\right)$};
  \node (node_0) at (315.0bp,8.5bp) [draw,draw=none] {$\left(a_{1} - 2,\,-a_{1} - 4,\,1,\,1\right)$};
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 3)\!:\; p'= 2,\, q' = 1,\, l = 1}$}
...
%\noindent $\lambda = $ $-\left(a_{3} + a_{4} + 3\right)\omega_{2} + \left(a_{4} + 1\right)\omega_{4}$ \\
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_1) at (224.0bp,8.5bp) [draw,draw=none] {$\left(1,\,-a_{3} - a_{4} - 4,\,a_{3},\,a_{4}\right)$};
  \node (node_0) at (65.5bp,8.5bp) [draw,draw=none] {$\left(0,\,-a_{3} - a_{4} - 3,\,a_{3},\,a_{4} + 1\right)$};
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 3)\!:\; p'= 2,\, q' = 2,\, l = 1}$}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_2) at (52.0bp,8.5bp) [draw,draw=none] {$\left(0,\,-a_{3} - 2,\,a_{3} + 1,\,0\right)$};
  \node (node_1) at (306.5bp,8.5bp) [draw,draw=none] {$\left(2,\,-a_{3} - 4,\,a_{3},\,0\right)$};
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 3)\!:\; p'= 2,\, q' = 2,\, l = 2}$}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 3)\!:\; p'= 2,\, q' = 3,\, l = 1}$}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_9) at (407.0bp,43.5bp) [draw,draw=none] {$\left(2,\,-5,\,1,\,0\right)$};
  \node (node_8) at (599.0bp,25.5bp) [draw,draw=none] {$\left(0,\,-5,\,0,\,0\right)$};
  \node (node_7) at (311.0bp,8.5bp) [draw,draw=none] {$\left(1,\,-4,\,1,\,1\right)$};
  \node (node_6) at (407.0bp,8.5bp) [draw,draw=none] {$\left(0,\,-4,\,0,\,2\right)$};
  \node (node_5) at (311.0bp,43.5bp) [draw,draw=none] {$\left(3,\,-4,\,0,\,0\right)$};
  \node (node_4) at (119.0bp,25.5bp) [draw,draw=none] {$\left(1,\,-2,\,1,\,0\right)$};
  \node (node_3) at (215.0bp,8.5bp) [draw,draw=none] {$\left(0,\,-3,\,2,\,0\right)$};
  \node (node_2) at (503.0bp,25.5bp) [draw,draw=none] {$\left(1,\,-5,\,0,\,1\right)$};
  \node (node_1) at (215.0bp,43.5bp) [draw,draw=none] {$\left(2,\,-3,\,0,\,1\right)$};
  \node (node_0) at (26.5bp,25.5bp) [draw,draw=none] {$\left(0,\,0,\,0,\,0\right)$};
  \draw [black,->] (node_6) ..controls (445.36bp,15.257bp) and (454.33bp,16.879bp)  .. (node_2);
  \draw [black,->] (node_1) ..controls (253.27bp,43.5bp) and (262.13bp,43.5bp)  .. (node_5);
  \draw [black,->] (node_9) ..controls (445.36bp,36.346bp) and (454.33bp,34.628bp)  .. (node_2);
  \draw [black,->] (node_5) ..controls (349.27bp,43.5bp) and (358.13bp,43.5bp)  .. (node_9);
  \draw [black,->] (node_7) ..controls (349.27bp,8.5bp) and (358.13bp,8.5bp)  .. (node_6);
  \draw [black,->] (node_0) ..controls (61.068bp,25.5bp) and (69.923bp,25.5bp)  .. (node_4);
  \draw [black,->] (node_2) ..controls (541.27bp,25.5bp) and (550.13bp,25.5bp)  .. (node_8);
  \draw [black,->] (node_4) ..controls (157.36bp,32.654bp) and (166.33bp,34.372bp)  .. (node_1);
  \draw [black,->] (node_7) ..controls (346.73bp,21.432bp) and (360.8bp,26.672bp)  .. (node_9);
  \draw [black,->] (node_4) ..controls (157.36bp,18.743bp) and (166.33bp,17.121bp)  .. (node_3);
  \draw [black,->] (node_1) ..controls (250.73bp,30.568bp) and (264.8bp,25.328bp)  .. (node_7);
  \draw [black,->] (node_3) ..controls (253.27bp,8.5bp) and (262.13bp,8.5bp)  .. (node_7);
%
\end{tikzpicture}
  \caption{Nilpotent cohomology / BGG resolution}
\end{figure}
...
\subsubsection{$\boldsymbol{\mathfrak{su}(2, 3)\!:\; p'= 2,\, q' = 3,\, l = 2}$}
