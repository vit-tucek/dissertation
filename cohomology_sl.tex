...
\subsubsection{$\mathrm{SU}(1, 1): p'= 1, q' = 1, l = 1 $}

Cone of unitarizable weights: $ 0 $ \\
Set of singular roots for the vertex: $\emptyset$ \\
...
\subsubsection{$\mathrm{SU}(1, 2): p'= 1, q' = 1, l = 1 $}
...
\subsubsection{$\mathrm{SU}(1, 2): p'= 1, q' = 2, l = 1 $}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_2) at (85.0bp,8.5bp) [draw,draw=none] {$\left(-2,\,1\right)$};
  \node (node_1) at (15.0bp,8.5bp) [draw,draw=none] {$\left(0,\,0\right)$};
  \node (node_0) at (159.0bp,8.5bp) [draw,draw=none] {$\left(-3,\,0\right)$};
  \draw [black,->] (node_2) ..controls (111.87bp,8.5bp) and (121.03bp,8.5bp)  .. (node_0);
  \draw [black,->] (node_1) ..controls (37.527bp,8.5bp) and (46.927bp,8.5bp)  .. (node_2);
%
\end{tikzpicture}
  \caption{Nilpotent cohomology / BGG resolution}
\end{figure}
...
\subsubsection{$\mathrm{SU}(1, 3): p'= 1, q' = 1, l = 1 $}
...
\subsubsection{$\mathrm{SU}(1, 3): p'= 1, q' = 2, l = 1 $}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_2) at (46.5bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - 2,\,a_{2} + 1,\,0\right)$};
  \node (node_1) at (279.0bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - 4,\,a_{2},\,0\right)$};
  \node (node_0) at (167.0bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - 3,\,a_{2},\,1\right)$};
  \draw [black,->] (node_0) ..controls (213.39bp,8.5bp) and (222.13bp,8.5bp)  .. (node_1);
...
\subsubsection{$\mathrm{SU}(1, 3): p'= 1, q' = 3, l = 1 $}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_3) at (272.5bp,8.5bp) [draw,draw=none] {$\left(-4,\,0,\,0\right)$};
  \node (node_2) at (187.5bp,8.5bp) [draw,draw=none] {$\left(-3,\,0,\,1\right)$};
  \node (node_1) at (21.0bp,8.5bp) [draw,draw=none] {$\left(0,\,0,\,0\right)$};
  \node (node_0) at (102.5bp,8.5bp) [draw,draw=none] {$\left(-2,\,1,\,0\right)$};
  \draw [black,->] (node_2) ..controls (220.04bp,8.5bp) and (229.1bp,8.5bp)  .. (node_3);
  \draw [black,->] (node_0) ..controls (135.04bp,8.5bp) and (144.1bp,8.5bp)  .. (node_2);
  \draw [black,->] (node_1) ..controls (49.779bp,8.5bp) and (58.821bp,8.5bp)  .. (node_0);
%
\end{tikzpicture}
  \caption{Nilpotent cohomology / BGG resolution}
\end{figure}
...
\subsubsection{$\mathrm{SU}(2, 2): p'= 1, q' = 1, l = 1 $}
...
\subsubsection{$\mathrm{SU}(2, 2): p'= 1, q' = 2, l = 1 $}

Cone of unitarizable weights: $ \left(a_{1} + 1\right)\omega_{1} - \left(a_{1} + 2\right)\omega_{2} $ \\
Set of singular roots for the vertex: $\{\epsilon_{2} - \epsilon_{4}$\} \\
...
\subsubsection{$\mathrm{SU}(2, 2): p'= 2, q' = 1, l = 1 $}

Cone of unitarizable weights: $ -\left(a_{3} + 2\right)\omega_{2} + \left(a_{3} + 1\right)\omega_{3} $ \\
Set of singular roots for the vertex: $\{\epsilon_{1} - \epsilon_{3}$\} \\
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_1) at (46.5bp,8.5bp) [draw,draw=none] {$\left(0,\,-a_{3} - 2,\,a_{3} + 1\right)$};
...
\subsubsection{$\mathrm{SU}(2, 2): p'= 2, q' = 2, l = 1 $}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_5) at (357.5bp,25.5bp) [draw,draw=none] {$\left(0,\,-4,\,0\right)$};
  \node (node_4) at (272.5bp,25.5bp) [draw,draw=none] {$\left(1,\,-4,\,1\right)$};
  \node (node_3) at (102.5bp,25.5bp) [draw,draw=none] {$\left(1,\,-2,\,1\right)$};
  \node (node_2) at (21.0bp,25.5bp) [draw,draw=none] {$\left(0,\,0,\,0\right)$};
  \node (node_1) at (187.5bp,8.5bp) [draw,draw=none] {$\left(2,\,-3,\,0\right)$};
  \node (node_0) at (187.5bp,43.5bp) [draw,draw=none] {$\left(0,\,-3,\,2\right)$};
  \draw [black,->] (node_1) ..controls (220.12bp,14.977bp) and (229.3bp,16.857bp)  .. (node_4);
  \draw [black,->] (node_4) ..controls (305.04bp,25.5bp) and (314.1bp,25.5bp)  .. (node_5);
  \draw [black,->] (node_3) ..controls (135.12bp,19.023bp) and (144.3bp,17.143bp)  .. (node_1);
  \draw [black,->] (node_2) ..controls (49.779bp,25.5bp) and (58.821bp,25.5bp)  .. (node_3);
  \draw [black,->] (node_0) ..controls (220.12bp,36.642bp) and (229.3bp,34.651bp)  .. (node_4);
  \draw [black,->] (node_3) ..controls (135.12bp,32.358bp) and (144.3bp,34.349bp)  .. (node_0);
%
\end{tikzpicture}
  \caption{Nilpotent cohomology / BGG resolution}
\end{figure}
...
\subsubsection{$\mathrm{SU}(2, 2): p'= 2, q' = 2, l = 2 $}

Cone of unitarizable weights: $ -\omega_{2} $ \\
Set of singular roots for the vertex: $\{\epsilon_{2} - \epsilon_{3}$\} \\
...
\subsubsection{$\mathrm{SU}(1, 4): p'= 1, q' = 1, l = 1 $}
...
\subsubsection{$\mathrm{SU}(1, 4): p'= 1, q' = 2, l = 1 $}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_2) at (374.0bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - a_{3} - 5,\,a_{2},\,a_{3},\,0\right)$};
  \node (node_1) at (65.5bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - a_{3} - 3,\,a_{2},\,a_{3} + 1,\,0\right)$};
  \node (node_0) at (224.0bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - a_{3} - 4,\,a_{2},\,a_{3},\,1\right)$};
  \draw [black,->] (node_0) ..controls (289.62bp,8.5bp) and (298.18bp,8.5bp)  .. (node_2);
...
\subsubsection{$\mathrm{SU}(1, 4): p'= 1, q' = 3, l = 1 $}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_3) at (183.5bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - 3,\,a_{2},\,1,\,0\right)$};
  \node (node_2) at (52.0bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - 2,\,a_{2} + 1,\,0,\,0\right)$};
  \node (node_1) at (306.5bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - 4,\,a_{2},\,0,\,1\right)$};
  \node (node_0) at (429.5bp,8.5bp) [draw,draw=none] {$\left(-a_{2} - 5,\,a_{2},\,0,\,0\right)$};
  \draw [black,->] (node_2) ..controls (112.53bp,8.5bp) and (121.18bp,8.5bp)  .. (node_3);
  \draw [black,->] (node_1) ..controls (358.38bp,8.5bp) and (367.09bp,8.5bp)  .. (node_0);
  \draw [black,->] (node_3) ..controls (235.38bp,8.5bp) and (244.09bp,8.5bp)  .. (node_1);
%
\end{tikzpicture}
  \caption{Nilpotent cohomology / BGG resolution}
\end{figure}
...
\subsubsection{$\mathrm{SU}(1, 4): p'= 1, q' = 4, l = 1 $}
...
\subsubsection{$\mathrm{SU}(2, 3): p'= 1, q' = 1, l = 1 $}
...
\subsubsection{$\mathrm{SU}(2, 3): p'= 1, q' = 2, l = 1 $}

Cone of unitarizable weights: $ \left(a_{1} + 1\right)\omega_{1} - \left(a_{1} + a_{3} + 4\right)\omega_{2} + \left(a_{3} + 1\right)\omega_{3} $ \\
Set of singular roots for the vertex: $\{\epsilon_{2} - \epsilon_{5}$\} \\
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_1) at (241.0bp,8.5bp) [draw,draw=none] {$\left(a_{1},\,-a_{1} - a_{3} - 4,\,a_{3},\,1\right)$};
  \node (node_0) at (74.0bp,8.5bp) [draw,draw=none] {$\left(a_{1} + 1,\,-a_{1} - a_{3} - 4,\,a_{3} + 1,\,0\right)$};
...
\subsubsection{$\mathrm{SU}(2, 3): p'= 1, q' = 3, l = 1 $}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_2) at (52.0bp,8.5bp) [draw,draw=none] {$\left(a_{1} + 1,\,-a_{1} - 2,\,0,\,0\right)$};
  \node (node_1) at (315.0bp,8.5bp) [draw,draw=none] {$\left(a_{1} - 2,\,-a_{1} - 4,\,1,\,1\right)$};
  \node (node_0) at (183.5bp,8.5bp) [draw,draw=none] {$\left(a_{1},\,-a_{1} - 3,\,1,\,0\right)$};
  \draw [black,->] (node_0) ..controls (235.42bp,8.5bp) and (244.1bp,8.5bp)  .. (node_1);
...
\subsubsection{$\mathrm{SU}(2, 3): p'= 2, q' = 1, l = 1 $}

Cone of unitarizable weights: $ -\left(a_{3} + a_{4} + 3\right)\omega_{2} + \left(a_{4} + 1\right)\omega_{4} $ \\
Set of singular roots for the vertex: $\{\epsilon_{1} - \epsilon_{4}$\} \\
...
\subsubsection{$\mathrm{SU}(2, 3): p'= 2, q' = 2, l = 1 $}
...
\node (node_2) at (306.5bp,8.5bp) [draw,draw=none] {$\left(2,\,-a_{3} - 4,\,a_{3},\,0\right)$};
  \node (node_1) at (183.5bp,8.5bp) [draw,draw=none] {$\left(1,\,-a_{3} - 3,\,a_{3},\,1\right)$};
  \node (node_0) at (52.0bp,8.5bp) [draw,draw=none] {$\left(0,\,-a_{3} - 2,\,a_{3} + 1,\,0\right)$};
  \draw [black,->] (node_0) ..controls (112.53bp,8.5bp) and (121.18bp,8.5bp)  .. (node_1);
  \draw [black,->] (node_1) ..controls (235.38bp,8.5bp) and (244.09bp,8.5bp)  .. (node_2);
%
\end{tikzpicture}
  \caption{Nilpotent cohomology / BGG resolution}
\end{figure}
...
\subsubsection{$\mathrm{SU}(2, 3): p'= 2, q' = 2, l = 2 $}
...
\subsubsection{$\mathrm{SU}(2, 3): p'= 2, q' = 3, l = 1 $}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_9) at (407.0bp,43.5bp) [draw,draw=none] {$\left(0,\,-4,\,0,\,2\right)$};
  \node (node_8) at (407.0bp,8.5bp) [draw,draw=none] {$\left(2,\,-5,\,1,\,0\right)$};
  \node (node_7) at (599.0bp,25.5bp) [draw,draw=none] {$\left(0,\,-5,\,0,\,0\right)$};
  \node (node_6) at (311.0bp,43.5bp) [draw,draw=none] {$\left(1,\,-4,\,1,\,1\right)$};
  \node (node_5) at (311.0bp,8.5bp) [draw,draw=none] {$\left(3,\,-4,\,0,\,0\right)$};
  \node (node_4) at (503.0bp,25.5bp) [draw,draw=none] {$\left(1,\,-5,\,0,\,1\right)$};
  \node (node_3) at (215.0bp,43.5bp) [draw,draw=none] {$\left(0,\,-3,\,2,\,0\right)$};
  \node (node_2) at (119.0bp,25.5bp) [draw,draw=none] {$\left(1,\,-2,\,1,\,0\right)$};
  \node (node_1) at (26.5bp,25.5bp) [draw,draw=none] {$\left(0,\,0,\,0,\,0\right)$};
  \node (node_0) at (215.0bp,8.5bp) [draw,draw=none] {$\left(2,\,-3,\,0,\,1\right)$};
  \draw [black,->] (node_4) ..controls (541.27bp,25.5bp) and (550.13bp,25.5bp)  .. (node_7);
  \draw [black,->] (node_2) ..controls (157.36bp,32.654bp) and (166.33bp,34.372bp)  .. (node_3);
  \draw [black,->] (node_9) ..controls (445.36bp,36.346bp) and (454.33bp,34.628bp)  .. (node_4);
  \draw [black,->] (node_6) ..controls (349.27bp,43.5bp) and (358.13bp,43.5bp)  .. (node_9);
  \draw [black,->] (node_2) ..controls (157.36bp,18.743bp) and (166.33bp,17.121bp)  .. (node_0);
  \draw [black,->] (node_1) ..controls (61.068bp,25.5bp) and (69.923bp,25.5bp)  .. (node_2);
  \draw [black,->] (node_5) ..controls (349.27bp,8.5bp) and (358.13bp,8.5bp)  .. (node_8);
  \draw [black,->] (node_0) ..controls (253.27bp,8.5bp) and (262.13bp,8.5bp)  .. (node_5);
  \draw [black,->] (node_0) ..controls (250.73bp,21.432bp) and (264.8bp,26.672bp)  .. (node_6);
  \draw [black,->] (node_8) ..controls (445.36bp,15.257bp) and (454.33bp,16.879bp)  .. (node_4);
  \draw [black,->] (node_3) ..controls (253.27bp,43.5bp) and (262.13bp,43.5bp)  .. (node_6);
  \draw [black,->] (node_6) ..controls (346.73bp,30.568bp) and (360.8bp,25.328bp)  .. (node_8);
%
\end{tikzpicture}
  \caption{Nilpotent cohomology / BGG resolution}
\end{figure}
...
\subsubsection{$\mathrm{SU}(2, 3): p'= 2, q' = 3, l = 2 $}
...
\begin{figure}[H]
  \centering
      \begin{tikzpicture}[>=latex,line join=bevel,]
%%
\node (node_2) at (30.0bp,8.5bp) [draw,draw=none] {$\left(0,\,-1,\,0,\,0\right)$};
  \node (node_1) at (222.0bp,8.5bp) [draw,draw=none] {$\left(3,\,-6,\,1,\,1\right)$};
  \node (node_0) at (126.0bp,8.5bp) [draw,draw=none] {$\left(2,\,-5,\,2,\,0\right)$};
  \draw [black,->] (node_0) ..controls (164.27bp,8.5bp) and (173.13bp,8.5bp)  .. (node_1);
  \draw [black,->] (node_2) ..controls (68.273bp,8.5bp) and (77.134bp,8.5bp)  .. (node_0);
%
\end{tikzpicture}
  \caption{Nilpotent cohomology / BGG resolution}
\end{figure}