...
\end{tikzpicture}  
  \caption{The reduced Hermitian symmetric pair for $\lambda =  -(2n-p-1)\omega_1+\omega_{p+1}$}
\end{figure}
...
\draw [dotted] (node_a) to (node_b);
\end{tikzpicture}  
  \caption{The reduced Hermitian symmetric pair for $\lambda = -(n+1)\omega_1 +\omega_{n-1} + \omega_n$}
\end{figure}  
...
\draw [dotted] (node_a) to (node_b);
\end{tikzpicture}  
  \caption{The reduced Hermitian symmetric pair for $\lambda = -(n-1)\omega_1 + \omega_n$}
\end{figure}  
...
\draw [dotted] (node_a) to (node_b);
\end{tikzpicture}  
  \caption{The reduced Hermitian symmetric pair for $\lambda = -(n-1)\omega_1  + \omega_{n-1}$}
\end{figure}  
